test_that("summarizeNeighbors function works", {
    ...
    pancreasSCE <- buildSpatialGraph(object = pancreasSCE,img_id = "ImageNb",type = "knn",k = 10,coords = c("Pos_X","Pos_Y"),name = "knn_10")
    pancreasSCE <- buildSpatialGraph(object = pancreasSCE,img_id = "ImageNb",type = "expansion",threshold = 20,coords = c("Pos_X","Pos_Y"),name = "exp_20")
    
    # Works celltypes version on knn
    expect_silent(cur_sce <- summarizeNeighbors(object = pancreasSCE,colPairName = "knn_10",summarize_by = "celltypes",
    ...
    expect_silent(cur_sce <- summarizeNeighbors(object = pancreasSCE,colPairName = "knn_10",summarize_by = "expression",
    ...
    expect_silent(cur_sce <- summarizeNeighbors(object = pancreasSCE,colPairName = "exp_20",summarize_by = "celltypes",
                                                    group = "CellType"))
    expect_silent(cur_sce <- summarizeNeighbors(object = pancreasSCE,colPairName = "exp_20",summarize_by = "celltypes",
    ...
    cur_markers <- rownames(pancreasSCE)
    expect_silent(cur_sce <- summarizeNeighbors(object = pancreasSCE,colPairName = "exp_20",summarize_by = "expression",
    ...
    cur_sce <- summarizeNeighbors(object = pancreasSCE,colPairName = "knn_10",summarize_by = "celltypes",
                       group = "CellType")
    ...
    cur_sce <- summarizeNeighbors(object = pancreasSCE,colPairName = "knn_10",summarize_by = "expression",
                                  assay_type = "exprs",subset_row = cur_markers,name = "knn_10_expMean")
    ...
    # Error
    expect_error(summarizeNeighbors("test"),
                 regexp = "'object' not of type 'SingleCellExperiment'.",
                 fixed = TRUE)
    expect_error(summarizeNeighbors(object = pancreasSCE),
                 regexp = "argument \"colPairName\" is missing, with no default",
                 fixed = TRUE)
    expect_error(summarizeNeighbors(object = pancreasSCE, colPairName =  "test"),
                 regexp = "'colPairName' not in colPair(object).",
                 fixed = TRUE)
    expect_error(summarizeNeighbors(object = pancreasSCE, colPairName = "knn_10",summarize_by = "test"),
                 regexp = "arg' should be one of “celltypes”, “expression”",
                 fixed = TRUE)
    expect_error(summarizeNeighbors(object = pancreasSCE, colPairName = "knn_10",summarize_by = "celltypes"),
                 regexp = "provide a colData entry to summarize by",
                 fixed = TRUE)
    expect_error(summarizeNeighbors(object = pancreasSCE, colPairName = "knn_10",summarize_by = "celltypes", group = "test"),
                 regexp = "'group' is not a valid enty of colData(object).",
                 fixed = TRUE)
    expect_error(summarizeNeighbors(object = pancreasSCE, colPairName = "knn_10",summarize_by = "expression"),
                 regexp = "'assay_type' not provided",
                 fixed = TRUE)
    expect_error(summarizeNeighbors(object = pancreasSCE, colPairName = "knn_10",summarize_by = "expression", assay_type = "test"),
                 regexp = "'assay_type' not an assay in the 'object'.",
                 fixed = TRUE)
    expect_error(summarizeNeighbors(object = pancreasSCE, colPairName = "knn_10",summarize_by = "expression", assay_type = "exprs"),
                 regexp = "subset_row not in rownames(object).",
                 fixed = TRUE)
    expect_error(summarizeNeighbors(object = pancreasSCE, colPairName = "knn_10",summarize_by = "expression", assay_type = "exprs", summaryStats =  "test"),
                 regexp = "arg' should be one of “mean”, “median”, “sd”, “var”",
                 fixed = TRUE)
