...
clustering 
5. [Test the attraction or avoidance between celltypes](#test-neighborhood)
...
measured and exported. To select the features of interest, the `imcRtools`
package provides the `show_cpout_features` function. Here, the exported features
can be interactively browsed:
