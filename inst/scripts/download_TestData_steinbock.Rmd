...
```{r download-cpout}
cur_url <- "https://github.com/BodenmillerGroup/TestData/releases/download/v1.0.6/210308_ImcTestData_steinbock.tar.gz"
...
files_of_interest <- c("cells.csv", "panel.csv", "steinbock.sh")
