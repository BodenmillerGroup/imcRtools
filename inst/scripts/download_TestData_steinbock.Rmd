...
```{r download-cpout}
cur_url <- "https://github.com/BodenmillerGroup/TestData/releases/download/v1.0.3/210308_ImcTestData_steinbock.tar.gz"
...
files_of_interest <- c("cell_intensities.csv", "cell_regionprops.csv",
                       "cells.csv", "panel.csv", "steinbock.sh")

folders_of_interest <- c("cell_graphs", "cell_intensities", "cell_regionprops")
