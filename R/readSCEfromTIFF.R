...
#'
#' @description Helper function to process .tiff files created with Steinbock 
...
#' @param image_df_path has to be a path to a images.csv file generated with Steinbock
#' @param panel_df_path has to be a path to a panel.csv file generated with Steinbock
...
#' are stored in single .tiff files after extraction with Steinbock.
#' 
...
#' the images.csv and panel.csv files generated by Steinbock must be passed. The 
#' column \code{acquisition_description} in images.csv as well as the column
#' \code{channel} in panel.csv must contain the spotted metal isotope name 
#' in the format \code{(mt)(mass)} (e.g. \code{Sm152} for Samarium isotope 
#' with the atomic mass 152). 
#'
#' @examples
#' # Read files from path
#' path <- system.file("extdata/spillover", package = "imcRtools")
#' image_df_path <- system.file("extdata/images.csv)
#' panel_df_path <- system.file("extdata/panel.csv)
#' 
